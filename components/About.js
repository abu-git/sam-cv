    ...
    <>
        ...
        <div className='px-8 md:px-12 py-9 bg-amber-50 text-black dark:bg-black dark:text-white grid grid-cols-1 md:grid-cols-2 items-center'>
            ...
            <section className='mt-4 md:mt-0'>
                <p className='text-2xl mb-4'>I am an African developer aiming to make my mark in the digital space. I spend most of time on creative pursuits and this usually involves me writing code. I enjoy the process and I am proud of the person I have become and still becoming.</p>
